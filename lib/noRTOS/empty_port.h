...
static inline int __gthread_create(__gthread_t *thread __attribute__((unused)), void *(*func)(void *)__attribute__((unused)),
...
static inline int __gthread_cond_timedwait(__gthread_cond_t *cond __attribute__((unused)), __gthread_mutex_t *mutex __attribute__((unused)),
                                           const __gthread_time_t *abs_timeout __attribute__((unused))) {
    return 0;
}
